package test.srz.com.testbar.view;
...
import test.srz.com.testbar.widget.TextImageView;
        ...
        implements View.OnClickListener
{
    ...
    public MyStepsView(Context context) {
        this(context, null);
    }

    public MyStepsView(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public MyStepsView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.my_steps_view);
        mDownTriangleColor = typedArray.getColor(R.styleable.my_steps_view_down_triangle_color, 0xffffffff);
        mStepTextSize = typedArray.getDimensionPixelSize(R.styleable.my_steps_view_text_size, mStepTextSize);
        mStepNormalTextColor = typedArray.getColor(R.styleable.my_steps_view_text_color, 0xffffffff);
        mSplitLineWidth = typedArray.getDimensionPixelSize(R.styleable.my_steps_view_split_line_width, mSplitLineWidth);
        typedArray.recycle();
...
//        mStepTextSize = DisplayUtil.sp2px(context, 18);
    ...
    private void initViews(){
        ...
        for(int i=0; i<mStepsCount; i++) {
            ...
            if(i < mStepsCount - 1) {
                ...
                splitLineView.setImageResource(R.drawable.my_split_line_disable);
    ...
    public void setCurrentStep(int stepIndex){
        ...
        if (mListener != null){
            mListener.viewSelect(mStepViews.get(mCurrentStepIndex));
        }
    }
